...
class modbusIface(object):
    ...
    def testComms(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modbus_iface.modbusIface/testComms',
    ...
    def openBus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modbus_iface.modbusIface/openBus',
    ...
    def listBus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modbus_iface.modbusIface/listBus',
    ...
    def busStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modbus_iface.modbusIface/busStatus',
    ...
    def closeBus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modbus_iface.modbusIface/closeBus',
    ...
    def readRegisters(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modbus_iface.modbusIface/readRegisters',
    ...
    def writeRegisters(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modbus_iface.modbusIface/writeRegisters',
    ...
    def scheduleWriteRegisters(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modbus_iface.modbusIface/scheduleWriteRegisters',
    ...
    def readRegisterSubscription(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/modbus_iface.modbusIface/readRegisterSubscription',
